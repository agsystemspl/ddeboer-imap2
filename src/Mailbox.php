...
use Ddeboer\Imap2\Exception\ImapStatusException;
use Ddeboer\Imap2\Exception\InvalidSearchCriteriaException;
use Ddeboer\Imap2\Exception\MessageCopyException;
use Ddeboer\Imap2\Exception\MessageMoveException;
use Ddeboer\Imap2\Exception\RenameMailboxException;
use Ddeboer\Imap2\Search\ConditionInterface;
use Ddeboer\Imap2\Search\LogicalOperator\All;

...
use Ddeboer\Imap2\Exception\CreateMailboxException;
use Ddeboer\Imap2\Exception\DeleteMailboxException;
use Ddeboer\Imap2\Exception\ImapGetmailboxesException;
use Ddeboer\Imap2\Exception\ImapNumMsgException;
use Ddeboer\Imap2\Exception\ImapQuotaException;
use Ddeboer\Imap2\Exception\MailboxDoesNotExistException;
...
final class Connection implements ConnectionInterface
{
    ...
    public function close(int $flag = 0): bool
    {
        ...
        return \imap2_close($stream, $flag);
    }
    ...
    private function initMailboxNames(): void
    {
        ...
        foreach ($mailboxesInfo as $mailboxInfo) {
            ...
            $name = \mb_convert_encoding($cleanname, 'UTF-8', \mb_detect_encoding($cleanname));
